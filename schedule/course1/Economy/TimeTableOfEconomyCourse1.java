package studentManagementSystem.schedule.course1.Economy;

import studentManagementSystem.schedule.Schedule;

public class TimeTableOfEconomyCourse1 extends Schedule {
    ...
    public static void tuesday(){
        ...
        System.out.println("Философия [аудитория 1420]");

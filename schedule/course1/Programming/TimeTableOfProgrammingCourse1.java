package studentManagementSystem.schedule.course1.Programming;

import studentManagementSystem.schedule.Schedule;

public class TimeTableOfProgrammingCourse1 extends Schedule {
    ...
    public static void tuesday(){
        ...
        System.out.println("Основы алгоритмизации и структур данных [аудитория 1420]");
